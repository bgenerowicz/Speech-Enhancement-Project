...
alpha_MMSE = 0.95;
alpha_n_MMSE=0.8;
alpha_periodogram = 0.5;
alpha_periodogram_noise = 0.85;
P_H0_MMSE = 0.5;
prior_SNR_MMSE = 0.1;  %prior average SNR for speech
hist_win = 130;
alphadd=0;
...
% MMSE estimation
[ sigma_n_estimates_MMSE, prob_H1_y_history, p_bar_history] = MMSE_estimator( yp_smooth, alpha_MMSE, alpha_n_MMSE, P_H0_MMSE, prior_SNR_MMSE);
